    ...
    <div className="min-h-screen bg-[#0b0f1a] text-white">
      ...
      <main className="mx-auto max-w-5xl px-7 py-10">
        ...
        <div className="mb-7 flex items-end justify-between">
          <div>
            ...
            <p className="mt-1 text-[13px] text-slate-500">
              {MOCK_TEAMS.length} teams · {totalMembers} employees · {assignedTeams} assigned to projects
            </p>
          </div>
        ...
        <div className="mb-7 grid grid-cols-2 gap-3 sm:grid-cols-4">
          {[
            { label: "Total Teams",    value: MOCK_TEAMS.length,  icon: "👥", accent: "bg-violet-500/20 text-violet-300" },
            { label: "Total Members",  value: totalMembers,        icon: "🧑‍💼", accent: "bg-blue-500/20 text-blue-300" },
            { label: "With Projects",  value: assignedTeams,       icon: "📁", accent: "bg-cyan-500/20 text-cyan-300" },
            { label: "Unassigned",     value: MOCK_TEAMS.length - assignedTeams, icon: "⏸️", accent: "bg-amber-500/20 text-amber-300" },
          ].map((s) => (
